...
public class LauncherCrashHandler implements UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        if (ex == null) {
            MxyLog.i(TAG, "handleException --- ex==null");
            return true;
        }
    ...
    public void collectCrashDeviceInfo(Context ctx) {
        try {
            ...
            MxyLog.e(TAG, "Error while collect package info:" + e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                if (DEBUG) {
                    MxyLog.d(TAG, field.getName() + " : " + field.get(null));
                }
            } catch (Exception e) {
                MxyLog.e(TAG, "Error while collect crash info" + e);
            }
        }
    }
